package com.example.dejan.ap_diplomska.view;
...
public class VerticalSeekBar extends SeekBar {
    ...
    public VerticalSeekBar(Context context) {
        super(context);
        //setProgressDrawable(new ColorDrawable(getResources().getColor(R.color.green_lightest)));
